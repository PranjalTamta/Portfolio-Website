  ...
  return (
    <div>
      ...
      <header id="header" className="bg-black">
        <div className="container">
          <nav className="flex justify-between items-center p-4">
            ...
            <ul
              id="sidemenu"
              className={`fixed top-0 right-0 bg-black h-full w-56 transform transition-transform ${
          ...
          <div className="header-text text-center p-8">
            ...
            <h1 className="text-4xl font-bold">
              Hi, I'm <span className="text-blue-500">Pranjal Tamta</span>{" "}
              <br /> from IIT ROPAR
            </h1>
          </div>
        </div>
        ...
        <div className="container flex flex-col md:flex-row items-center">
          ...
          <div className="about-col-2 md:w-1/2 p-4">
            ...
            <p className="mb-4">
              ...
              user-friendly interfaces and seamless experiences. I enjoy
              tackling challenges in both front-end and back-end development,
              constantly learning new technologies to improve my skills and stay
              ahead in the field.
            </p>
            ...
            <div className="tab-contents">
              {activeTab === "skills" && (
                <ul>
                  <li>
                    <span>Web Development:</span> HTML, CSS, JS
                  </li>
                  <li>
              ...
              {activeTab === "experience" && (
                <ul>
                  <li>
                    <span>Project Leadership:</span> Team Coordination
                  </li>
                  <li>
                    <span>E-commerce Development:</span> Design Improvements
                  </li>
                  <li>
                    <span>Database Management:</span> SQL/Postgres
                  </li>
                </ul>
              )}
              {activeTab === "education" && (
                <ul>
                  <li>
                    <span>IIT Ropar:</span> BTech
                  </li>

                  <li>
                    <span>Graph Theory:</span> Trees/Network Flow
                  </li>
                </ul>
              )}
            </div>
      ...
      <section id="services" className="py-12 bg-black">
        <div className="container">
          <h1 className="sub-title text-3xl font-bold text-center mb-8">
            My Services
          </h1>
          <div className="services-list grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-4 text-center">
              ...
              <p className="mb-2">
                Web development, UI/UX design, responsive layouts, backend
                integration, seamless functionality.
              </p>
            ...
            <div className="p-4 text-center">
              ...
              <p className="mb-2">
                Creative and functional designs, with attention to user
            ...
            <div className="p-4 text-center">
              ...
              <p className="mb-2">
                Designing mobile apps that are intuitive and engaging, with a
      ...
      <section id="portfolio" className="py-12">
        <div className="container">
          ...
          <div className="work-list grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="work relative">
              ...
              <div className="layer absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                <h3 className="text-black text-xl mb-2">Social Media App</h3>
                <p className="text-black mb-2">
                  Connect with talented people around the world.
                </p>
            ...
            <div className="work relative">
              ...
              />
              <div className="layer absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                <h3 className="text-black text-xl mb-2">Music App</h3>
                <p className="text-black mb-2">
                  Experience the rhythm with a seamless music experience.
                </p>
                <a href="#" className="text-blue-300">
                  <i className="fa-solid fa-arrow-up-right-from-square"></i>
                </a>
            ...
            <div className="work relative">
              ...
              />
              <div className="layer absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                <h3 className="text-black text-xl mb-2">Online Shopping App</h3>
                <p className="text-black mb-2">
                  Shop with ease using our user-friendly interface.
                </p>
                <a href="#" className="text-blue-300">
                  <i className="fa-solid fa-arrow-up-right-from-square"></i>
                </a>
          ...
          <div className="text-center mt-8">
            <a
              href="#"
              className="btn inline-block px-6 py-2 bg-blue-500 text-black rounded hover:bg-blue-600"
            >
              See more
            </a>
          </div>
      ...
      <section id="contact" className="py-12 bg-black">
        <div className="container">
          <div className="flex flex-col md:flex-row">
            <div className="contact-left md:w-1/2 p-4">
              ...
              <p className="mb-2">
                <i className="fa-solid fa-paper-plane"></i> contact@iitrpr.com
              </p>
              <p className="mb-2">
        ...
        <div className="copyright text-center py-4">
          <p>
            Copyright @ Sudhanshu. Made{" "}
            <i className="fa-solid fa-heart text-red-500"></i> with passion and
            precision.
          </p>
        </div>
      </section>
