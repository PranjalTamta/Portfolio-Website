      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div className="bg-[#262626] p-6 text-sm font-light rounded-xl transition duration-500 hover:bg-[#ff004f] hover:-translate-y-2 shadow-md group">
          ...
          <p className="text-gray-300 group-hover:text-white mb-2">
            Creating responsive websites with clean code and smooth UI using
            HTML, CSS, and React.
          </p>
          <span className="text-white text-xs mt-2 inline-block opacity-50">
            Learn more
          </span>
        </div>
        ...
        <div className="bg-[#262626] p-6 text-sm font-light rounded-xl transition duration-500 hover:bg-[#ff004f] hover:-translate-y-2 shadow-md group">
          ...
          <p className="text-gray-300 group-hover:text-white mb-2">
            Designing intuitive user experiences with a focus on usability and
            visual appeal.
          </p>
          <span className="text-white text-xs mt-2 inline-block opacity-50">
            Learn more
        ...
        <div className="bg-[#262626] p-6 text-sm font-light rounded-xl transition duration-500 hover:bg-[#ff004f] hover:-translate-y-2 shadow-md group">
          ...
          <p className="text-gray-300 group-hover:text-white mb-2">
            Developing cross-platform mobile apps using Flutter with beautiful
            UI and robust logic.
          </p>
          <span className="text-white text-xs mt-2 inline-block opacity-50">
            Learn more
