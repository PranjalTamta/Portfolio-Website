...
export default function Navbar() {
  ...
  return (
    <nav className="w-full fixed top-0 left-0 z-50 bg-blue-600 text-white shadow-md">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        {/* Logo */}
        <a href="#home">
          <img src="/logo.png" alt="Logo" className="h-10 w-auto" />
          <span className=" font-bold text-white">PRANJAL</span>
        </a>
        ...
        <ul className="hidden md:flex space-x-12 text-lg font-semibold">
          {["home", "about", "services", "portfolio", "contact"].map((id) => (
            <li key={id}>
              <a href={`#${id}`} className="relative group hover:text-red-400">
