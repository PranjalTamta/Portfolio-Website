...
export default function AboutMe() {
  ...
  return (
    <section className="mb-16 px-4 md:px-8" id="about">
      <h2 className="text-5xl font-extrabold text-black mb-4 mt-10 text-center md:text-left pl-0 md:pl-[570px]">
        About Me
      </h2>
      ...
      <div className="flex flex-col md:flex-row items-start gap-10 max-w-7xl mx-auto">
        ...
        <div className="text-center md:text-left w-full max-w-2xl">
          <p className="text-lg text-gray-400 leading-relaxed mb-4">
            I’m a passionate web and app developer and a 4rd-year B.Tech student
            at IIT Ropar. I enjoy turning complex problems into simple,
          ...
          <div className="text-gray-400 text-base leading-relaxed">
            {activeTab === "skills" && (
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Others: Python, C/C++</li>
              </ul>
            )}
            {activeTab === "experience" && (
              <ul className="list-disc list-inside space-y-1">
                <li>Member, Coding Club IIT Ropar</li>
                <li>Developed multiple full-stack </li>
              </ul>
            )}
            {activeTab === "education" && (
              <ul className="list-disc list-inside space-y-1">
                <li>B.Tech student, IIT Ropar (2022–2026)</li>
                <li>Senior Secondary: CBSE, 79.6% (2021)</li>
                <li>Secondary: CBSE, 87.4% (2019)</li>
              </ul>
            )}
          </div>
        </div>
